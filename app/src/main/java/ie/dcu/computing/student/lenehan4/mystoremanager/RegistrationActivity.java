...
public class RegistrationActivity extends AppCompatActivity {
    ...
    String email, name, status, password;
                    ...
                    firebaseAuth.createUserWithEmailAndPassword(user_email, user_password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            if(task.isSuccessful()) {
                                ...
                                Log.d("Jawad", "onComplete: "+task.getException().getLocalizedMessage());
    ...
    private void setupUIViews(){
        ...
        userStatus = (EditText)findViewById(R.id.etStatus);
    ...
    private Boolean validate(){
        ...
        if(name.isEmpty() || password.isEmpty() || email.isEmpty() || status.isEmpty() || imagePath == null
         || companyNameText.isEmpty()){
    ...
    private void sendUserData(){
        ...
        UserProfile userProfile = new UserProfile(status, email, name, companyName.getText().toString());
