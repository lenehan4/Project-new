...
public class UpdateProfile extends AppCompatActivity {
    ...
    private EditText newUserName, newUserStatus, newUserEmail, company;
    private Button save;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        newUserStatus = findViewById(R.id.etStatusUpdate);
        newUserEmail = findViewById(R.id.etEmailUpdate);
        save = findViewById(R.id.btnSave);
        updateProfilePic = findViewById(R.id.ivProfileUpdate);
        company = findViewById(R.id.update_company);
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                newUserStatus.setText(userProfile.getUserStatus());
        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String status = newUserStatus.getText().toString();
                String email = newUserEmail.getText().toString();

                UserProfile userProfile = new UserProfile(status, email, name, company.getText().toString());
